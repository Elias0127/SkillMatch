        ...
        <div className='dashboard-container'>
            <div className='profile'>
                ...
                <div className='menu'> 
                    ...
                    {role === 'employer' && (
                        <a href="#" className={activeSection === 'postJobs' ? 'menu-links active' : 'menu-links'} onClick={() => handleMenuClick('postJobs')}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" width="20" height="20" className="back-icon">
